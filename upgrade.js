...
4. OUTPUT FORMAT: valid, raw JSON only. No markdown.
{
  ...
  "reason": "concise linguistic explanation (max 15 words). Focus on flow/tone."
      ...
      const PROMPT_TREE = {
        speaking: {
          1: `TARGET: LEVEL 1 — PROFICIENCY & FLOW
          Goal: Rewrite the input to reflect C1/C2-level English. It must sound fully natural and idiomatic.
          Core Instruction:
          - If simple/intermediate: Upgrade grammar and vocabulary.
          - If already advanced: Paraphrase using alternative C1/C2 structures to improve flow.
          - Crucial: It must sound like something a proficient speaker would actually SAY, not read.
          Focus:
          - Advanced, idiomatic vocabulary and collocations.
          - Natural contractions, reductions, and linking.
          - Fix literal translations/Calques.
        ...
        writing: {
          1: `TARGET: LEVEL 1 — PROFICIENCY & FLOW
          Goal: Rewrite the input to reflect C1/C2-level English. It must look like standard, high-quality prose.
          Core Instruction:
          - If simple/intermediate: Upgrade grammar and vocabulary.
          - If already advanced: Paraphrase for better cohesion and impact.
          Focus:
          - Precise vocabulary and written collocations.
          - Improve sentence structure (avoiding run-ons or fragments).
      ...
      // Fallback: If level isn't 1 or 2, default to 1.
